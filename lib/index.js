...
Socket.prototype._flush = function() {
  ...
  // If an Async zmq operation is happening then don't flush because
  // multiple threads can not talk to the same context at once.
  if (self._zmq.isasyncbusy) return
